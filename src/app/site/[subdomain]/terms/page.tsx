...
export default async function TermsPage({ params }: PageProps<"/site/[subdomain]/terms">) {
  ...
  return (
    <div className="prose prose-sm max-w-none space-y-4 text-neutral-800">
      ...
      <h2 className="text-lg font-medium text-neutral-900">SMS messaging program</h2>
      <p>
      ...
      <h2 className="text-lg font-medium text-neutral-900">Opt-in and opt-out</h2>
      <p>
      ...
      <h2 className="text-lg font-medium text-neutral-900">Supported carriers</h2>
      <p>
      ...
      <h2 className="text-lg font-medium text-neutral-900">No guarantee</h2>
      <p>
      ...
      <h2 className="text-lg font-medium text-neutral-900">Changes to these terms</h2>
      <p>
