...
export function CampaignForm({ token }: { token: string }) {
  ...
  return (
    <form action={formAction} className="space-y-4 border-t border-neutral-200 pt-6">
      ...
      <div>
        <label className="block text-sm text-neutral-700" htmlFor="useCase">
          Use case
        </label>
      ...
      <div>
        <label className="block text-sm text-neutral-700" htmlFor="description">
      ...
      <div>
        <label className="block text-sm text-neutral-700" htmlFor="optInDetails">
      ...
      <div>
        <label className="block text-sm text-neutral-700" htmlFor="sampleMessages">
